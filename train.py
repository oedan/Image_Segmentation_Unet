...
if __name__ == "__main__":
    ...
    # 指定训练集地址，开始训练
    data_path =  "C:/Users/OEDan/Desktop/unet/skin"# 本地的数据集位置
    print("进度条出现卡着不动不是程序问题，是他正在计算，请耐心等待")
    train_net(net, device, data_path, epochs=40, batch_size=1) #epochs=40、50、100 batch_size=2、4
    #训练好的模型保存在best_model.pth
